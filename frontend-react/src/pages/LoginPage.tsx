      ...
      <div id="tudo">
        <section className="login_page">
          ...
          <div className="char_buttons">
            ...
            <div>
              <button className="button" onClick={() => setClicou1(true)}>
                Zenchi
              </button>
            </div>
            ...
            <div>
              <button className="button" onClick={() => setClicou2(true)}>
                Atnos
              </button>
            </div>
            {clicou3 && (
            ...
            <div>
              <button className="button" onClick={() => setClicou3(true)}>
                Sam
              </button>
            </div>
          </div>
